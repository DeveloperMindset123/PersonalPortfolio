import {
  ...
  const testimonials = [
    {
      testimonial:
        "Ayan Das is an exceptional candidate for the LSAMP Summer Research Program, with his top-notch work, self-starting attitude, and dedication to continuous improvement, making him a valuable contributor to any research establishment.",
    ...
    {
      testimonial:
        "As a teammate who worked on the word count capstone project for programming language with Ayan, he took lead of the project and guided us through the entire project in an easily comprehensible manner that allowed us to complete the project on time and meet the neccessary requirements listed.",
      name: "Teammate 1",
